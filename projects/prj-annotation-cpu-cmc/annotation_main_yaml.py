...
def parse_args():
    ...
    add_argument(parser, 'in_mqtt3', 'IN_MQTT_URL_3', 'mqtt://192.168.200.206:1883,topic=cmc,qos=2,queue_max_len=100')
...
async def main():
    ...
    try:
        ...
        input_interface = MultiInputInterface([input_video_interface, input_message_interface1, input_message_interface2, input_message_interface3])
